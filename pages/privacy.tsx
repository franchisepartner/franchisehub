...
export default function PrivacyPolicy() {
  return (
    <div className="max-w-4xl mx-auto px-3 sm:px-8 py-12 min-h-screen">
      <Head>
        <title>Kebijakan Privasi - FranchiseNusantara</title>
        <meta name="description" content="Kebijakan Privasi penggunaan platform FranchiseNusantara." />
      </Head>
      ...
      <div className="mb-10">
        ...
        <div className="text-base md:text-lg text-gray-500">
          Komitmen FranchiseNusantara melindungi data dan privasi Anda.
        </div>
      </div>
      ...
      <div className="bg-white/90 rounded-2xl shadow-lg border border-blue-100 p-6 md:p-10 space-y-9">
        ...
        <section className="flex gap-5">
          ...
          <div>
            ...
            <ul className="list-disc pl-6 space-y-2 text-gray-700">
              ...
              <li>
                <strong>Data Transaksi:</strong> Info pembayaran seperti nama, email, nomor rekening/e-wallet, diproses melalui payment gateway. <b>FranchiseNusantara tidak pernah menyimpan data kartu kredit atau data sensitif pembayaran.</b>
              </li>
              <li>
        ...
        <section className="flex gap-5">
          ...
          <div>
            ...
            <ul className="list-disc pl-6 text-gray-700 space-y-1">
              <li>Mengelola & menyediakan layanan FranchiseNusantara</li>
        ...
        <section className="flex gap-5">
          ...
          <div>
            ...
            <p className="text-gray-700">
              Kami menerapkan sistem keamanan teknologi, administrasi, dan fisik untuk mencegah akses tidak sah, kehilangan, atau penyalahgunaan data. Akses ke data pribadi dibatasi hanya untuk tim FranchiseNusantara yang membutuhkan untuk menjalankan layanan.
            </p>
          </div>
        </section>
        ...
        <section className="flex gap-5">
          ...
          <div>
            ...
            <p className="text-gray-700">
              FranchiseNusantara <span className="font-bold">tidak pernah menjual atau membagikan data pribadi pengguna</span> ke pihak lain tanpa izin Anda. Data hanya dibagikan jika:
            </p>
            <ul className="list-disc pl-6 text-gray-700 space-y-1">
        ...
        <section className="flex gap-5">
          ...
          <div>
            ...
            <p className="text-gray-700">
              Anda berhak mengakses, memperbarui, atau menghapus data pribadi yang tersimpan di FranchiseNusantara, kecuali data yang harus kami simpan sesuai hukum yang berlaku. Untuk permintaan penghapusan data, hubungi email resmi kami.
            </p>
          </div>
        </section>
        ...
        <section className="flex gap-5">
          ...
          <div>
            ...
            <p className="text-gray-700">
              FranchiseNusantara menggunakan cookies untuk menyimpan preferensi, membantu login otomatis, analitik penggunaan, dan personalisasi tampilan. Anda bisa mengatur preferensi cookies di browser.
            </p>
          </div>
        </section>
        ...
        <section className="flex gap-5">
          ...
          <div>
            ...
            <p className="text-gray-700">
              Jika ada pertanyaan, keluhan, atau permintaan terkait privasi di FranchiseNusantara, silakan hubungi{" "}
