...
export default function Home() {
  ...
  useEffect(() => {
    const fetchFranchises = async () => {
      const { data, error } = await supabase
        ...
        .select(`
          id, franchise_name, description, category,
          investment_min, location, logo_url, slug
        `)
  ...
  return (
    <div className="w-full">
      {/** ================= Banner Section ================= **/}
      {/** Container banner dengan ketinggian “ceper” (200px – 240px) **/}
      <div className="relative w-full h-[240px] md:h-[280px] lg:h-[320px] bg-blue-700 overflow-hidden">
        {/**
         * Menampilkan banner-franchisehub.PNG dari folder /public
         * -> ukuran full‐width, height 100%, object‐cover
         */}
        <Image
        ...
        {/**
         * Curve / lengkungan putih di pojok kiri bawah
         * Di sini kita pakai sebuah <div> bundar (border‐radius full)
         * yang diletakkan di kiri bawah, sehingga membentuk curve.
         */}
        <div className="absolute bottom-0 left-0 w-[200px] h-[200px] bg-white rounded-full transform translate-x-[-50%] translate-y-[50%]">
          {/** Kosong, hanya membentuk shape putih bulat **/}
        </div>

        {/**
         * Overlay pencarian (tab + input) diletakkan di tengah‐bawah banner
         * kita letakkan sedikit menjorok ke atas banner, agar tampak menyatu
         */}
        <div className="absolute left-1/2 bottom-[-20px] transform -translate-x-1/2 w-full max-w-3xl px-4">
      ...
      {/**
       * Spacer agar konten di bawahnya (menu & daftar franchise) tidak tertutup
       * oleh overlay pencarian
       */}
      <div className="h-[100px] md:h-[120px] lg:h-[140px]"></div>
